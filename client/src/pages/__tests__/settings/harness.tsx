...
const { setLanguagePreferenceMock, tMock, useAuthMock } = vi.hoisted(() => {
  const translations: Record<string, string> = {
    ...
    'pages.settings.oidcClientAuthMethod': 'Client Authentication Method',
    'pages.settings.oidcClientAuthMethodClientSecret': 'Client Secret',
    'pages.settings.oidcClientAuthMethodWorkloadIdentity': 'Workload Identity Federation (no secret)',
    'pages.settings.oidcClientSecret': 'Client Secret',
    'pages.settings.oidcFederatedTokenFile': 'Federated Token File Path',
